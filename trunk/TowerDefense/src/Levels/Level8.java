...
public class Level8 extends Level {
	...
	public Level8(Game g) {
	    ...
	    queue.add(new Monster(g.mobFire, this, g.getEnviro()));
	    queue.add(new Monster(g.mobEarth, this, g.getEnviro()));
	    queue.add(new Monster(g.mobAir, this, g.getEnviro()));
	    queue.add(new Monster(g.mobWater, this, g.getEnviro()));
	    queue.add(new Monster(g.mobFire, this, g.getEnviro()));
	    queue.add(new Monster(g.mobEarth, this, g.getEnviro()));
	    queue.add(new Monster(g.mobAir, this, g.getEnviro()));
